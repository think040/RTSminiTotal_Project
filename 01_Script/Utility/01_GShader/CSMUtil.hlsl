...
struct CSMUtil
{
    ...
    static float GetShadowFactor_Directional(float3 posW, float3 normalW, out float intensity)
    {
        float sf = 0.0f;
        int i = 0;
        float NdotL = getNdotL(normalize(normalW), normalize(-dirW_light.xyz));
    ...
    static float GetSpecularFactor_1(float3 posW, float3 normalW)
    {
