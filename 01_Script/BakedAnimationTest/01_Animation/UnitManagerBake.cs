...
public class UnitManagerBake : MonoBehaviour
{
    ...
    void InitAnim()
    {
        ...
        {           
            ...
            //boneOffset_idx = new ComputeBuffer(bmCount, sizeof(uint));
            //boneOffset_input = new ComputeBuffer(bmCount, Marshal.SizeOf<float4x4>());
    ...
    class BoneCompute
    {
        ...
        UnitManagerBake unitMan;
        ComputeShader cshader;
        int ki_sample;
        int ki_offset;
        int ki_static;

        public void Init(ComputeShader cshader, UnitManagerBake unitMan)
        {
    ...
    class VertexCompute
    {
        ...
        //float4x4[] Wbone;
        Mesh skMesh;
        public void Init(ComputeShader cshader, Mesh skMesh, UnitManagerBake unitMan, int insCount)
        {
            this.unitMan = unitMan;
            this.cshader = cshader;
    ...
    class VertexComputeSt
    {
        ...
        public void Init(ComputeShader cshader, Mesh[] stMeshes, UnitManagerBake unitMan, int insCount)
        {
            this.unitMan = unitMan;
            this.cshader = cshader;
